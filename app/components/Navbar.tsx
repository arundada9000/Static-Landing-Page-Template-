  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] md:top-5 md:left-1/2 md:-translate-x-1/2 md:w-[95%] lg:w-[90%] md:max-w-6xl md:rounded-full ${
          scrolled
          ...
          <div className="flex items-center justify-between h-16 md:h-[70px] gap-4">
            ...
            >
              ...
              <div className="hidden sm:block leading-none">
                <span className="font-extrabold text-base lg:text-lg text-stone-900 block transition-colors">
                  {siteConfig.name}
                </span>
                <span
            ...
            <div className="flex items-center gap-1 sm:gap-2 lg:gap-3 shrink-0">
              ...
              <Link
                href="/wishlist"
                className="relative p-2 text-stone-600 hover:text-rose-500 hover:bg-rose-50 rounded-full transition-colors active:scale-95 flex items-center justify-center"
              ...
              {/* Mobile Hamburger */}
              <button
                className="xl:hidden p-2 text-stone-600 hover:bg-stone-100 rounded-full transition-colors active:scale-95 flex items-center justify-center cursor-pointer"
              ...
              >
                ...
                <div
                  className={`p-1.5 rounded-xl transition-all duration-300 ease-out ${
                    isActive
                      ? "scale-110 mb-0.5"
                      : "text-stone-500 group-hover:text-stone-800 group-hover:scale-105 group-hover:bg-black/5"
                  }`}
                >
                  <Icon
